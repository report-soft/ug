...
async function generatePDFs() {
    ...
    for (const record of data) {
        ...
        pdf.setFontSize(11);
        pdf.text(`Name: ${record.name}`, 2.5, 6.5);
        pdf.text(`Class: ${record.class}`, 11.4, 6.5);
        pdf.text(`Year: ${record.year}`, 14, 6.5);
        pdf.text(`Term: ${record.term}`, 16.2, 6.5);

        pdf.setFontSize(9);
        pdf.text(`${record.englishAOI}`, 8.7, 10);
        pdf.text(`${record.mathematicsAOI}`, 8.7, 10.5);
        pdf.text(`${record.physicsAOI}`, 8.7, 11);
        pdf.text(`${record.chemistryAOI}`, 8.7, 11.5);
        pdf.text(`${record.biologyAOI}`, 8.7, 12);
        pdf.text(`${record.geographyAOI}`, 8.7, 12.5);
        pdf.text(`${record.historyAOI}`, 8.7, 13);
        pdf.text(`${record.kiswahiliAOI}`, 8.7, 13.5);
        pdf.text(`${record.peAOI}`, 8.7, 14);
        pdf.text(`${record.creAOI}`, 8.7, 14.5);
        pdf.text(`${record.agricultureAOI}`, 8.7, 15);
        pdf.text(`${record.entAOI}`, 8.7, 15.5);
        pdf.text(`${record.artAOI}`, 8.7, 16);

        pdf.text(`${record.english}`, 15.1, 10);
        pdf.text(`${record.mathematics}`, 15.1, 10.5);
        pdf.text(`${record.physics}`, 15.1, 11);
        pdf.text(`${record.chemistry}`, 15.1, 11.5);
        pdf.text(`${record.biology}`, 15.1, 12);
        pdf.text(`${record.geography}`, 15.1, 12.5);
        pdf.text(`${record.history}`, 15.1, 13);
        pdf.text(`${record.kiswahili}`, 15.1, 13.5);
        pdf.text(`${record.pe}`, 15.1, 14);
        pdf.text(`${record.cre}`, 15.1, 14.5);
        pdf.text(`${record.agriculture}`, 15.1, 15);
        pdf.text(`${record.ent}`, 15.1, 15.5);
        pdf.text(`${record.art}`, 15.1, 16);
        
        pdf.setFontSize(9);
        pdf.text(`${Descriptoreng}`, 11.7, 10);
        pdf.text(`${Descriptormtc}`, 11.7, 10.5);
        pdf.text(`${Descriptorphy}`, 11.7, 11);
        pdf.text(`${Descriptorche}`, 11.7, 11.5);
        pdf.text(`${Descriptorbio}`, 11.7, 12);
        pdf.text(`${Descriptorgeo}`, 11.7, 12.5);
        pdf.text(`${Descriptorhis}`, 11.7, 13);
        pdf.text(`${Descriptorkis}`, 11.7, 13.5);
        pdf.text(`${Descriptorpe}`, 11.7, 14);
        pdf.text(`${Descriptorcre}`, 11.7, 14.5);
        pdf.text(`${Descriptoragric}`, 11.7, 15);
        pdf.text(`${Descriptorent}`, 11.7, 15.5);
        pdf.text(`${Descriptorart}`, 11.7, 16);

        pdf.text(`${Caleng}`, 10.2, 10);
        pdf.text(`${Calmtc}`, 10.2, 10.5);
        pdf.text(`${Calphy}`, 10.2, 11);
        pdf.text(`${Calche}`, 10.2, 11.5);
        pdf.text(`${Calbio}`, 10.2, 12);
        pdf.text(`${Calgeo}`, 10.2, 12.5);
        pdf.text(`${Calhis}`, 10.2, 13);
        pdf.text(`${Calkis}`, 10.2, 13.5);
        pdf.text(`${Calpe}`, 10.2, 14);
        pdf.text(`${Calcre}`, 10.2, 14.5);
        pdf.text(`${Calagric}`, 10.2, 15);
        pdf.text(`${Calent}`, 10.2, 15.5);
        pdf.text(`${Calart}`, 10.2, 16);

        pdf.text(`${Gradeeng}`, 17.1, 10);
        pdf.text(`${Grademtc}`, 17.1, 10.5);
        pdf.text(`${Gradephy}`, 17.1, 11);
        pdf.text(`${Gradeche}`, 17.1, 11.5);
        pdf.text(`${Gradebio}`, 17.1, 12);
        pdf.text(`${Gradegeo}`, 17.1, 12.5);
        pdf.text(`${Gradehis}`, 17.1, 13);
        pdf.text(`${Gradekis}`, 17.1, 13.5);
        pdf.text(`${Gradepe}`, 17.1, 14);
        pdf.text(`${Gradecre}`, 17.1, 14.5);
        pdf.text(`${Gradeagric}`, 17.1, 15);
        pdf.text(`${Gradeent}`, 17.1, 15.5);
        pdf.text(`${Gradeart}`, 17.1, 16);

        pdf.text(`Classteacher's Comment:   ${Ctcomment}`, 2.5, 17);
        pdf.text(`Headteacher's Comment:    ${Htcomment}`, 2.5, 17.5);
        pdf.text("Headteacher's Signature: ....................", 2.5, 18);
        pdf.text(11.5, 18, 'Next Term Begins on: ' + nextTermDate);
         ...
         pdf.text("Av.AOI", 8.4, 8.3);
         pdf.setFontSize(9);
         pdf.text("Scores", 8.4, 8.7);
         pdf.text("(20)", 8.6, 9.1);
 
         pdf.setFontSize(9);
         pdf.text("Av.AOI", 10,8.3);
         pdf.setFontSize(9);
         pdf.text("Scores", 10,8.7);
         pdf.text("(3)", 10.2,9.1);
 
         
         pdf.text("Descriptor", 11.8,8.3);
         pdf.text("End of", 14.9,8.3);
         pdf.text("Term (80)", 14.7,8.7);
         pdf.text("Grade", 16.8,8.3);
         pdf.text("(Tr's)", 18.4,8.3);
         pdf.text("(Initials)", 18.2,8.7);
 
         //Grading Table
         pdf.setFontSize(8);
         pdf.text("GRADE", 2.5, 19);
         pdf.text("SCORE RANGE", 5, 19);
         pdf.text("GRADE DESCRIPTOR", 8.1, 19);
         ...
         pdf.text("90-100", 6, 19.5);
         pdf.text("80-89", 6, 20.5);
         pdf.text("70-79", 6, 21.5);
         pdf.text("60-69", 6, 22.5);
         pdf.text("50-59", 6, 23);
         pdf.text("40-49", 6, 23.5);
         pdf.text("30-39", 6, 24.5);
         pdf.text("<30", 6, 25.5);
 
         pdf.text("Achieved MOST or ALL competencies in the subject exceptionally well. The", 8.1, 19.5 );
         pdf.text("learner is outstanding in most or all areas of the subject ", 8.1, 20);
         pdf.text("Achieved MOST or ALL competencies exceedingly well. The learner is ", 8.1, 20.5);
         pdf.text("excellent in most or all areas of the subject. ", 8.1, 21);
         pdf.text("Achieved MOST but not all competencies well. The learner is very good in a", 8.1, 21.5);
         pdf.text("number of areas in the subject", 8.1, 22);
         pdf.text("Achieved a good number of competencies in the subject. ", 8.1, 22.5);
         pdf.text("Achieved a basic number of competencies in the subject. ", 8.1, 23);
         pdf.text("Achieved bare minimum number of competencies in the subject, just enough to ", 8.1, 23.5);
         pdf.text("exhibit the required knowledge and skills ", 8.1, 24);
         pdf.text("Achieved a number of competencies but not enough to make him or her", 8.1, 24.5);
         pdf.text("competent across the subject", 8.1, 25);
         pdf.text("Achieved very few or no competencies. ", 8.1, 25.5);
 
         pdf.text("IDENTIFIER", 2.5, 26);
         pdf.text("SCORE RANGE", 5, 26);
         pdf.text("DESCRIPTOR", 8.1, 26);
 
         pdf.text("1", 3.4, 26.5);
         pdf.text("2", 3.4, 27);
         pdf.text("3", 3.4, 27.5);
 
         pdf.text("2.5-3.0", 6, 26.5);
         pdf.text("1.5-2.4", 6, 27);
         pdf.text("0.9-1.4", 6, 27.5);
 
         pdf.text("Outstanding: Most or all LOs achieved for overall achievement. ", 8.1, 26.5);
         pdf.text("Moderate: Many LOs achieved enough for overall achievement. ", 8.1, 27);
         pdf.text("Basic: Few LOs achieved but not sufficient for overall achievement. ", 8.1, 27.5);
         
 
         // Tr's Initials
 
         pdf.text("K.B", 18.5, 10);
         pdf.text("M.J", 18.5, 10.5);
         pdf.text("K.A", 18.5, 11);
         pdf.text("M.R", 18.5, 11.5);
         pdf.text("T.G", 18.5, 12);
         pdf.text("A.B.D", 18.5, 12.5);
         pdf.text("N.F", 18.5, 13);
         pdf.text("N.Z.A", 18.5, 13.5);
         pdf.text("K.G", 18.5, 14);
         pdf.text("K.J.M", 18.5, 14.5);
         pdf.text("N.J", 18.5, 15);
         pdf.text("B.A", 18.5, 15.5);
         pdf.text("B.A", 18.5, 16);
         ...
         pdf.text("_______________________________________________", 2.3, 16.2, {
             angle: 90
         });
         pdf.text("_______________________________________________", 8, 16.2, {
             angle: 90
         });
 
         pdf.text("_______________________________________________", 9.8, 16.2, {
             angle: 90
         });
 
         pdf.text("_______________________________________________", 11.5, 16.2, {
             angle: 90
         });
 
         pdf.text("_______________________________________________", 14, 16.2, {
             angle: 90
         });
 
         pdf.text("_______________________________________________", 16.5, 16.2, {
             angle: 90
         });
 
         pdf.text("_______________________________________________", 18, 16.2, {
             angle: 90
         });
 
         pdf.text("_______________________________________________", 19.5, 16.2, {
             angle: 90
         });
 
         
         //Columns
         pdf.text("__________________________________________________________________________________________________",  2.3, 16.1,);
         pdf.text("__________________________________________________________________________________________________", 2.3, 7.8,);
         
         pdf.text("__________________________________________________________________________________________________", 2.3, 9.5,);
         pdf.text("__________________________________________________________________________________________________", 2.3, 10,);
         pdf.text("__________________________________________________________________________________________________", 2.3, 10.5,);
         pdf.text("__________________________________________________________________________________________________", 2.3, 11,);
         pdf.text("__________________________________________________________________________________________________", 2.3, 11.5,);
         pdf.text("__________________________________________________________________________________________________", 2.3, 12,);
         pdf.text("__________________________________________________________________________________________________", 2.3, 12.5,);
         pdf.text("__________________________________________________________________________________________________", 2.3, 13,);
         pdf.text("__________________________________________________________________________________________________", 2.3, 13.5,);
         pdf.text("__________________________________________________________________________________________________", 2.3, 14,);
         pdf.text("__________________________________________________________________________________________________", 2.3, 14.5,);
         pdf.text("__________________________________________________________________________________________________", 2.3, 15,);
         pdf.text("__________________________________________________________________________________________________", 2.3, 15.5,);
 
 
         //Grade table borders
         pdf.text("___________________________________________________", 2.3, 27.5, {
             angle: 90
         });
         pdf.text("___________________________________________________", 4.8, 27.5, {
             angle: 90
         });
         pdf.text("___________________________________________________", 7.9, 27.5, {
             angle: 90
         });
         pdf.text("___________________________________________________", 19.3, 27.5, {
             angle: 90
         });
         //rows
         pdf.text("________________________________________________________________________________________________", 2.4, 18.5, );
         pdf.text("________________________________________________________________________________________________", 2.4, 19, );
         pdf.text("________________________________________________________________", 8, 19.5, );
         pdf.text("________________________________________________________________________________________________", 2.4, 20, );
         pdf.text("________________________________________________________________", 8, 20.5, );
         pdf.text("________________________________________________________________________________________________", 2.4, 21, );
         pdf.text("________________________________________________________________", 8, 21.5, );
         pdf.text("________________________________________________________________________________________________", 2.4, 22, );
         pdf.text("________________________________________________________________________________________________", 2.4, 22.5, );
         pdf.text("________________________________________________________________________________________________", 2.4, 23, );
         pdf.text("________________________________________________________________", 8, 23.5, );
         pdf.text("________________________________________________________________________________________________", 2.4, 24, );
         pdf.text("________________________________________________________________", 8, 24.5, );
         pdf.text("________________________________________________________________________________________________", 2.4, 25, );
         pdf.text("________________________________________________________________________________________________", 2.4, 25.5, );
         pdf.text("________________________________________________________________________________________________", 2.4, 26, );
         pdf.text("________________________________________________________________________________________________", 2.4, 26.5, );
         pdf.text("________________________________________________________________________________________________", 2.4, 27, );
         pdf.text("________________________________________________________________________________________________", 2.4, 27.5, );
...
/*async function generatePDFs() {
    ...
    for (const record of data) {
        ...
        pdf.text(`Headteacher's Comment:    ${Htcomment}`, 2.5, 17.5);
        pdf.text("Headteacher's Signature: ....................", 2.5, 18);
        pdf.text("Next Term Begins on: ....................", 11.5, 18);
        ...
        pdf.setFontSize(10);
        pdf.text("End of Chapter Activites of Integration Scores", 7.2, 7.6);
        //pdf.text("Year:" `${record.year}`, 18.5, 16);
        //pdf.text("Class:"`${record.class}`, 18.5, 16);
       // pdf.text(`${record.english}`, 15.1, 10);
        //pdf.text("Name:"`${record.name}`, 2.5, 7.2);
       // pdf.text("Term:"`${record.Term}`, 18.5, 16);
